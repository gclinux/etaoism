...
class Paipan{
	...
	public function naYin($tg,$dz){
		...
		$map = [
			0=>[
				0=>['海中金',3,9],2=>['大溪水',4,4],4=>['佛灯火',1,1],
				6=>['沙中金',3,6],8=>['井泉水',4,2],10=>['山头火',1,4]
			],
			2=>[
				0=>['涧下水',4,1],2=>['炉中火',1,2],4=>['沙中土',2,2],
				6=>['天河水',4,6],8=>['山下火',1,3],10=>['房上土',2,4]
			],
			4=>[
				0=>['霹雳火',1,6],2=>['城头土',2,6],4=>['大林木',0,9],
				6=>['天上火',1,9],8=>['大驿土',2,9],10=>['平地木',0,6]
			],
			6=>[
				0=>['壁上土',2,3],2=>['松柏木',0,4],4=>['白腊金',3,2],
				6=>['路边土',2,1],8=>['石榴木',0,1],10=>['钗钏金',3,3]
			],
			8=>[
				0=>['桑松木',0,2],2=>['金箔金',3,1],4=>['长流水',4,3],
				6=>['杨柳木',0,3],8=>['剑锋金',3,4],10=>['大海水',4,9]
			]
		];
